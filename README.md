...
- **股票市场跟踪与分析**: 集成雅虎财经 API，提供实时的股票数据、历史价格图表和常用的技术指标分析。
- **灵活的数据导出**: 支持将分析报告和数据导出为多种格式，包括 Excel (`.xlsx`) 和 PDF，方便分享和归档。
- **Web 内容抓取**: 内置 Puppeteer 和 Cheerio，能够从指定网页抓取和解析所需数据。
...
- **股票数据**: [yahoo-finance2](https://github.com/gadicc/node-yahoo-finance2)
- **数据导出**: [ExcelJS](https://github.com/exceljs/exceljs), [jsPDF](https://github.com/parallax/jsPDF)
- **Web 抓取**: [Puppeteer](https://pptr.dev/), [Cheerio](https://cheerio.js.org/)
