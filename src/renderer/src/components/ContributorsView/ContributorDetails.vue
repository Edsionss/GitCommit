    ...
    <a-card v-if="contributor" class="contributor-detail-card">
      ...
      <div class="contributor-profile">
        ...
        <div class="contributor-detail-section">
          <h4>主要工作文件</h4>
          <a-table :data-source="contributor.topFiles" :columns="fileColumns" size="small" :pagination="false">
          </a-table>
        </div>
      </div>
    </a-card>
...
.chart-container, .activity-chart { height: 300px; width: 100%; position: relative; }
