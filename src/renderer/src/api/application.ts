 ...
 */
export const onWindowStateChange = (callback: (state: 'maximized' | 'unmaximized') => void): (() => void) => {
 ...
 * 获取项目依赖
 */
export const getDependencies = (): Promise<{ dependencies: Record<string, string>; devDependencies: Record<string, string> }> => {
